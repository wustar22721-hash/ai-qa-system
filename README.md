...
> 支持扩展接入 GitHub 文档等多源数据，构建统一的知识检索入口。
...
| **多源扩展** | 架构预留 GitHub 数据源接入能力，可抓取仓库文档、Issue 等内容 |
...
| `GITHUB_TOKEN` | - | GitHub 个人访问令牌（用于 Git 操作及未来 GitHub 数据源） | - |
...
- [ ] GitHub 数据源插件 —— 抓取仓库 README、Wiki、Issue 等构建跨源知识库
- [ ] 对话历史持久化与多轮对话支持
- [ ] 知识库热更新（无需重启服务）
- [ ] Docker 一键部署
- [ ] 飞书机器人接入
